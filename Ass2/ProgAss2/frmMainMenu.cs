    ...
    public partial class frmMainMenu : Form
    {
        ...
        private void btnSelect_Click(object sender, EventArgs e)                    //select button
        {
            ...
            if(radbtnSurf.Checked)                                                  //if surf is selected as a radio button
            {
                ...
                object[,] surf = new object[,]                                      //creates an array with all the information, notes its obj type
                {
            ...
            {
                int s3 = 0;                                                         //declarations to follow description on line 50
                int s4 = 0;
