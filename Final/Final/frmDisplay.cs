...
namespace Final
{
    public partial class frmDisplay : Form,Iexit
    {
        ...
        //*************************************************************************************************************************************************
        private void btnDlt_Click(object sender, EventArgs e)                           //delete button
        {
            ...
            {
                DeleteForm.dlt = lstboxStock.SelectedItem.ToString();                   //adds listbox item selected to Delete form
                this.Hide();                                                            //hides current form
